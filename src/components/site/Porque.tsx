      ...
      <div className="container-page">
        ...
        >
          ...
          >
            ...
            <CarouselPrevious className="left-1/2 -translate-x-[calc(100%+0.5rem)] top-auto bottom-0 translate-y-0 sm:left-0 sm:-translate-x-0 sm:top-1/2 sm:-translate-y-1/2 sm:bottom-auto h-10 w-10 bg-white/10 border-white/20 text-white hover:bg-brand hover:text-white hover:border-brand" />
            <CarouselNext className="left-1/2 translate-x-2 top-auto bottom-0 translate-y-0 sm:left-auto sm:right-0 sm:translate-x-0 sm:top-1/2 sm:-translate-y-1/2 sm:bottom-auto h-10 w-10 bg-white/10 border-white/20 text-white hover:bg-brand hover:text-white hover:border-brand" />
          </Carousel>
        </div>
      </div>
    </section>
